  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-10">
        ...
        {/* TOP SECTION: Image Gallery + Booking Card (Grid Layout) */}
        <div className="grid lg:grid-cols-3 gap-8 mb-10">
          
          {/* Image Gallery (Spans 2/3 columns on large screens) */}
          ...
          {/* Right Sidebar - Booking Card (Spans 1/3 columns) */}
        ...
        {/* BOTTOM SECTION: Title, Info, Tabs, and Slots (Full Width) */}
