      ...
      >
        ...
        <div className="flex flex-col flex-1 p-5 bg-gray-50">
          ...
          <div className="flex items-start justify-between mb-3 gap-2">
            <h3
              className="text-lg font-semibold text-gray-900 leading-snug line-clamp-1 flex-1 min-w-0"
              title={experience.title}
            >
              {experience.title}
            </h3>
            <span className="text-sm text-gray-700 bg-gray-200 rounded-md px-3 py-1 whitespace-nowrap shrink-0">
              {experience.location.city}
            </span>
          </div>
